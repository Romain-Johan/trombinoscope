							...
							<div className="search-option">
								...
								<div>
									...
									<label htmlFor="type-posts">
										<svg className="edit-pen-title">
										<use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#post"></use>
										</svg>
										<span>Mission</span>
									</label>
								</div>
								<div>
									...
									<label htmlFor="type-images">
										<svg className="edit-pen-title">
										<use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#images"></use>
										</svg>
										<span>Poste</span>
									</label>
								</div>
								<div>
									<input name="type" type="radio" value="type-special" id="type-special" />
									<label htmlFor="type-special">
										<svg className="edit-pen-title">
											<use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#special"></use>
										</svg>
